(function () {
  ...
  function loadTextureForImage(index) {
    ...
    let num = getRandom(1, 109);
    let imgIndex = zeroPadding(num, 3);
    // const url = `https://zekkei-kyushu.s3.ap-southeast-2.amazonaws.com/tv/2022/04/0${imgIndex}_re.jpg`;
    // const url = `https://source.unsplash.com/random/${image.width}x${image.height}`
    const url = `../public/img/zekkei_kyushu/gallery/${imgIndex}.jpg`;
